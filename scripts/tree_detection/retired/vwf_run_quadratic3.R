...
existing_params2 = read_csv(data("parameter_set_definitions/vwfdefs_quadraticsearch1and2.csv"))
...
c = seq(-0.002, 0.001, by = 0.0005)
b = seq(0.03,0.2, by = 0.01)
a = seq(-5, -1, by= 0.5)
smooth = c(1)

params = expand.grid(a=a,b=b,c=c,smooth=smooth)

params = anti_join(params,existing_params)
params = anti_join(params,existing_params2)
...
params$detection_params_name = paste0("vwf_",str_pad(1:nrow(params)+4000, width=4, pad = "0"))
...
# save vwf params
write_csv(params,data("parameter_set_definitions/vwfdefs_quadraticsearch3.csv"))
